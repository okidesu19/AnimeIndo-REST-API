...
from Config.schemas import AnimeViewResponse, PaginatedResponse, OrderBy, ViewType
...
async def animeView_playwright(view: ViewType, order_by: OrderBy = OrderBy.LATEST, page: int = 1) -> PaginatedResponse:
    anime_data = []
